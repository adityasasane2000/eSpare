...
function Into() {
  ...
  let services = [
    {
      name: '01/ Software Development'
    },
    {
      name: "02/ Web Development"
    },
    {
      name: "03/ Mobile App Development"
    }
  ]
      ...
      {/* <div className='space-y-24'> */}
        ...
        <div className=''>
          <div className='w-full flex flex-col sm:flex-row md:flex-row sm:my-14 sm:space-x-20 sm:w-screen sm:mr-40'>
              <div className='left w-full items-center'>
              ...
              <div className='relative right p-6 sm:w-screen'>
                  ...
                  <div className='relative my-9 ml-7 justify-center sm:justify-center sm:items-center sm:w-screen'>
                     <img className="sm:h-96 sm:w-screen sm:-my-16 rounded-lg"src="./alesiakazantcevaxlm6fpwk5qunsplash-1@2x.png" alt="" />
                  </div>
        ...
        <div className='sm:inline-block sm:w-96'>
          <p className='p-3 text-xs sm:w-screen sm:pt-16 sm:pl-5 sm:text-3xl sm:font-medium text-nowrap'>
          Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br/>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,<br/>when an unknown printer took a galley of type and scrambled it to make a <br/>type specimen book. It has survived not only five centuries
          </p>
        </div>

        <div className=' flex justify-center sm:w-[200%] sm:justify-center'>
        ...
        <div className=''>
          <h1 className='text-2xl font-bold p-9 sm:flex sm:text-6xl sm:font-bold sm:p-20 sm:flex-row'>Our Services</h1>
          <div className='w-36 justify-center ml-28 text-center sm:w-[45rem] sm:grid sm:grid-cols-2 sm:space-x-60 sm:ml-20 sm:space-y-12'>
              <Card></Card>
              <Card></Card>
          </div>
