                ...
                <div className='md:w-[70%] space-y-8'>
                    ...
                    <div>
                        {<div className='flex justify-center space-x-[20%]'>
                            <button className='bg-yellow-400 text-lg font-semibold w-[45%] h-auto rounded-xl text-nowrap'>Lets's talk</button>
                            <button className='bg-white text-lg font-semibold w-[30%] h-auto rounded-xl  '>Projects</button>
                        </div>}
                    </div>
                </div>
