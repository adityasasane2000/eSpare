...
function Info() {
    return (
        ...
        <div className='w-[100%] lg:p-5 mt-5'>
            <div className='h-12'>
            ...
            <div className='flex flex-col p-4 space-y-16 justify-center items-center md:flex md:flex-row-reverse md:-mt-6'>

                <div className='relative flex justify-center md:flex md:justify-around'>
                    <img className="rounded-2xl w-[85%] md:w-[80%] xl:w-[65%] md:ml-[10%]" src="./alesiakazantcevaxlm6fpwk5qunsplash-1@2x.png" alt="image" />
                ...
                <div className='md:w-[70%] space-y-8 xl:w-[40%]'>
                    ...
                    <p className='text-sm xl:text-base font-[Inter]'>eSparse Matrix Solutions Private Limited is a Best Software Development Company that includes Enterprise Software development, Website designing and development, Mobile application development, Digital marketing.</p>
                    {/* <div> */}
