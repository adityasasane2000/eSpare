  ...
  return (
    <div>
        ...
        <div className='p-4 md:p-8'>
            ...
            <div>
                <BlogCard title={"The Top 5 CRM Software for Small Businesses"} info={"Growth is the main obstacle for small businesses. And by growth, we mean greater visibility, more clients, professionals, and—most importantly—revenue. And as is widely known, a lot needs to happen when working toward this p...Read More"} img1={"image 45.png"} img2={"image 44.png"}></BlogCard>
